...
public class MainViewController : UIViewController
{
    public override void ViewDidLoad()
    {
        ...
        {
            passed++;
            Console.WriteLine($"[MUSICKIT-TEST] PASS: {name}");
        }

        void Fail(string name, string error)
        {
            failed++;
            Console.WriteLine($"[MUSICKIT-TEST] FAIL: {name} — {error}");
        }
        ...
        try
        {
            ...
            Console.WriteLine($"[MUSICKIT-TEST] MusicAuthorization metadata size = {metadata.Size}");
        ...
        try
        {
            ...
            Console.WriteLine($"[MUSICKIT-TEST] DolbyAtmos description = {desc}");
        ...
        try
        {
            ...
            Console.WriteLine($"[MUSICKIT-TEST] SpatialAudio description = {desc}");
        ...
        catch (Exception ex)
        {
            ...
            Console.WriteLine($"[MUSICKIT-TEST] SpatialAudio trapped as expected on older OS: {ex.Message}");
        ...
        Console.WriteLine($"[MUSICKIT-TEST] Results: {passed} passed, {failed} failed");
        if (failed == 0)
