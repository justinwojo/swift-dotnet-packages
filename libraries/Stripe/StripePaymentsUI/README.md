# Swift.StripePaymentsUI

.NET bindings for [StripePaymentsUI](https://github.com/stripe/stripe-ios.git), a Swift library.

## Installation

```
dotnet add package Swift.StripePaymentsUI
```
